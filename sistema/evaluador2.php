      ...
      <?php if($tipe=='2'){ ?>
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> Proyectos Generales</a></li>
            <li><a href="index2.html"><i class="fa fa-circle-o"></i>Semifinalistas</a></li>
            <li><a href="index2.html"><i class="fa fa-circle-o"></i>Finalistas</a></li>
          </ul>
        </li>
         <li class="active treeview">
          <a href="#">
        ...
        <li class="header">Menu</li>
        <li class="active treeview">
          <a href="evaluador.php?usrt=<?=$idusr?>"  >
            <i class="fa fa-dashboard"></i> <span>Perfil</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
